...
#menamilkan halaman utama
@app.route('/')
def home():
    return render_template("index.html")

#menamilkan fof uf karyawan jika terdeteksi sbg karyawan
@app.route('/popup')
def popup():
    return render_template('popUpKaryawan.html')

#menamilkan form isi tamu jika terdeteksi sbg tamu
@app.route('/tamu')
def tamu():
...
#menamilkan fof uf tamu jika terdeteksi sbg tamu
@app.route('/modal')
def modal():
    return render_template("modal.html")
...
#menamilkan total tamu hari ini
@app.route('/tamuHari')
def tamuHari():
    cur = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
...
#menamilkan total tamu minggu ini
...
#menamilkan total tamu bulan ini
@app.route('/tamuBulan')
def tamuBulan():
    cur = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
...
#menamilkan total keseluruhan tamu
@app.route('/totalTamu')
def totalTamu():
    cur = mysql.connection.cursor(MySQLdb.cursors.DictCursor)
...
#menamilkan halaman tambah data
